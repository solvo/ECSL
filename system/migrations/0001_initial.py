# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-12-13 10:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_country', models.IntegerField(verbose_name='Entry and out from country')),
                ('out_country', models.IntegerField(verbose_name='Entry and otu from country')),
                ('entry_port', models.CharField(max_length=100, verbose_name='Entry port')),
                ('out_port', models.CharField(max_length=100, verbose_name='Out port')),
                ('entry_country_date', models.DateTimeField(verbose_name='Entry country Date')),
                ('out_country_date', models.DateTimeField(verbose_name='Out country Date')),
                ('letter', models.TextField(verbose_name='Migratory letter')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
        ),
        migrations.CreateModel(
