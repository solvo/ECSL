...
class Profile(Model):
    ...
    entry_country_date = DateTimeField(verbose_name=_('Fecha de Entrada al país'), null=True)
    out_country_date = DateTimeField(verbose_name=_('Fecha de Salida del país'), null=True)
